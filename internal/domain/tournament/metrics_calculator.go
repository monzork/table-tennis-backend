...
func (c *MetricsCalculator) Calculate(t *Tournament, snapshots []ParticipantSnapshot) *TournamentMetrics {
	...
	// Since we only have the start/end tournament snapshots here and not per-match snapshots, 
