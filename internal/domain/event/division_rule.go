...
// DivisionRule defines match rules for a specific division and stage within a event.
...
// generateDivisionRuleID creates a deterministic ID from event and division IDs.
...
var (
	ErrInvalidTournamentID = errorf("event ID is required")
