...
func (uc *RegisterPlayerUseCase) Execute(ctx context.Context, firstName, secondName, lastName, secondLastName string, birthdate, gender, country, department, whatsAppNumber, nationalID, idFrontURL, idBackURL string, singlesElo, doublesElo int16) (*playerDomain.Player, error) {
