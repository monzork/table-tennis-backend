...
func NewGetOccupiedTablesUseCase(matchRepo event.MatchRepository) *GetOccupiedTablesUseCase {
	return &GetOccupiedTablesUseCase{
		matchRepo: matchRepo,
	}
}

func (uc *GetOccupiedTablesUseCase) Execute(ctx context.Context, t *event.Event) ([]int, error) {
