...
func (m *mockMovePlayerRepository) Save(ctx context.Context, t *tournamentDomain.Event) error {
	return nil
}

func (m *mockMovePlayerRepository) GetByID(ctx context.Context, id string) (*tournamentDomain.Event, error) {
	if m.getErr != nil {
		return nil, m.getErr
	}
	return m.t, nil
...
func (m *mockMovePlayerRepository) Update(ctx context.Context, t *tournamentDomain.Event) error {
	return nil
}

func (m *mockMovePlayerRepository) UpdateGroups(ctx context.Context, t *tournamentDomain.Event) error {
	m.updCalls++
	return m.updErr
}
...
func (m *mockMovePlayerRepository) AddParticipant(ctx context.Context, tournamentID string, playerID string, singlesElo, doublesElo int16) error {
	return nil
}
