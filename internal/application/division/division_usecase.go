...
func (uc *DivisionUseCase) Save(ctx context.Context, id, name string, displayOrder int, minElo int16, maxElo *int16, category, gender, color string, placementEloMultiplier float64) error {
	...
	if placementEloMultiplier > 0 {
		d.PlacementEloMultiplier = placementEloMultiplier
	}
