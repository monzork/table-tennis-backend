...
func (m *mockPlayerRepo) UpdateElo(ctx context.Context, players []*player.Player) error {
	return nil
}

func (m *mockPlayerRepo) UpdateEloForCategory(ctx context.Context, ageCategory string, players []*player.Player) error {
	return nil
}
