...
func TestPublicHandler_TournamentSelfRegistration(t *testing.T) {
	...
	tourney, err := tournamentDomain.NewEvent(uuid.New().String(), "Open Championship", "singles", "elimination", "open", time.Now(), time.Now().Add(24*time.Hour), []tournamentDomain.Rule{}, 2, nil, false)
	if err != nil {
